...
static const u1_t PROGMEM APPEUI[8] = { 0x13,0x16, 0x04, 0xD0, 0x7E, 0xD5, 0xB3, 0x70};
// LSB mode
static const u1_t PROGMEM DEVEUI[8] = { 0x00, 0xE7, 0x35, 0xBE, 0x6C, 0xB2, 0x13, 0x2D };
// MSB mode
static const u1_t PROGMEM APPKEY[16] = {
0x75, 0x7F, 0xE4, 0xB5, 0xD0, 0xBB, 0x39, 0x03, 0x9D, 0x24, 0x55, 0x35, 0xD8, 0x42, 0xCE, 0xD7
};
...
static const unsigned TX_INTERVAL = 10;
...
void do_send(osjob_t *j)
{
    if (joinStatus == EV_JOINING) {
      ...
      getGPS();
        ...
        uint8_t mydata[40];
        gpsinfo.getBytes(mydata, gpsinfo.length());
        // Prepare upstream data transmission at the next possible time.
        LMIC_setTxData2(1, mydata, gpsinfo.length(), 0);
        os_setTimedCallback(&sendjob, os_getTime() + sec2osticks(TX_INTERVAL), do_send);
